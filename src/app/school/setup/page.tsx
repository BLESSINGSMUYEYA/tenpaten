...
export default async function SchoolSetupPage() {
    ...
    return (
        <main className="min-h-screen relative overflow-hidden bg-linear-to-br from-[#1a1b41] via-[#22204f] to-[#12132e]">
            {/* Background blobs */}
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-[-15%] right-[-10%] w-[700px] h-[700px] bg-brand-accent/8 rounded-full blur-[140px]" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-brand-primary/40 rounded-full blur-[120px]" />
            ...
            <div className="relative z-10 flex min-h-screen">
                ...
                <div className="hidden lg:flex flex-col justify-between w-[420px] xl:w-[480px] shrink-0 p-12 border-r border-white/5 relative overflow-hidden">
                    ...
                    <div className="absolute inset-0">
                        ...
                        />
                        <div className="absolute inset-0 bg-linear-to-b from-[#1a1b41]/60 via-transparent to-[#1a1b41]/80" />
                    </div>

                    {/* Top: Logo + Tag */}
                    <div className="relative z-10">
                        <TenpatenLogo variant="white" />
                        <div className="mt-8 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-accent/15 border border-brand-accent/30 text-brand-accent text-[10px] font-black uppercase tracking-[0.25em]">
                    ...
                    <div className="relative z-10 space-y-6">
                        <h1 className="text-4xl xl:text-5xl font-black text-white tracking-tight leading-[1.1]">
                            Join the Global
                            <span className="block text-transparent bg-clip-text bg-linear-to-r from-brand-accent to-[#f0c84e]">
                                Education Network
                            </span>
                        </h1>
                        ...
                        <div className="space-y-3">
                            {[
                                ...
                                <div key={item} className="flex items-center gap-3">
                                    <div className="w-5 h-5 rounded-full bg-brand-accent/20 border border-brand-accent/40 flex items-center justify-center shrink-0">
                ...
                <div className="flex-1 flex flex-col items-center justify-center py-12 px-4 sm:px-8 lg:px-12 overflow-y-auto">
                    ...
                    <div className="flex flex-col items-center text-center mb-8 space-y-4 lg:hidden">
                        <TenpatenLogo variant="white" />
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-accent/15 border border-brand-accent/30 text-brand-accent text-[10px] font-black uppercase tracking-[0.25em]">
                            <Building2 className="w-3 h-3" />
                            Institutional Setup
                        </div>
