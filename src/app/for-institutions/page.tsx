        ...
        <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 shadow-2xl">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 lg:h-24 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Link href="mailto:partnerships@tenpaten.com" className="hidden sm:inline-flex px-8 py-3 bg-[#d5a22d] text-[#1a1b41] rounded-xl text-[11px] uppercase tracking-[0.2em] font-black hover:bg-white transition-all active:scale-95">Partner With Us</Link>
            ...
            {open && (
                <div className="md:hidden bg-[#1a1b41] border-t border-white/5 px-6 py-10 space-y-2 rounded-b-[2.5rem]">
                    ...
                    <div className="pt-6 mt-4 border-t border-white/5">
                        <Link href="mailto:partnerships@tenpaten.com" className="flex items-center justify-center py-4 rounded-xl text-[10px] font-black text-[#1a1b41] bg-[#d5a22d] uppercase tracking-widest">Partner With Us</Link>
                    </div>
                </div>
            )}
        </nav>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                        {features.map((f, i) => (
                            <motion.div key={i}
                                ...
                                className="group bg-white border border-gray-100 rounded-[2rem] p-8 hover:border-[#d5a22d]/30 hover:shadow-xl hover:shadow-[#d5a22d]/5 transition-all duration-500 relative overflow-hidden">
                                ...
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#d5a22d]/20 bg-[#d5a22d]/8 text-[9px] font-black uppercase tracking-[0.25em] text-[#d5a22d] mb-5">
                                ...
                                <div className="w-11 h-11 rounded-2xl bg-[#1a1b41]/5 flex items-center justify-center mb-4 group-hover:bg-[#1a1b41] transition-all duration-300">
                                    <f.icon className="w-5 h-5 text-[#1a1b41] group-hover:text-[#d5a22d] transition-colors duration-300" />
                                </div>
                                <h3 className="text-[#1a1b41] font-black text-base uppercase tracking-tight leading-snug mb-3 group-hover:text-[#d5a22d] transition-colors duration-300">{f.title}</h3>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {steps.map((s, i) => (
                            <motion.div key={i}
                                ...
                                className="group relative bg-white/5 border border-white/10 rounded-[2rem] p-8 hover:border-[#d5a22d]/30 hover:bg-white/8 transition-all duration-500">
                                <div className="absolute top-0 left-8 right-8 h-[2px] bg-gradient-to-r from-transparent via-[#d5a22d] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                <div className="w-12 h-12 rounded-2xl bg-[#d5a22d]/10 border border-[#d5a22d]/20 flex items-center justify-center text-[#d5a22d] font-black text-sm mb-6">
                                    {s.n}
                                </div>
                            ...
                            <motion.div key={i}
                                ...
                                <div className="bg-[#1a1b41] px-8 py-10 flex flex-col items-center text-center">
                                    ...
                                    <div className="flex items-center gap-1.5 mt-2">
                                        <span className="w-1.5 h-1.5 rounded-full bg-[#d5a22d]" />
                                        <p className="text-[#d5a22d] text-[9px] font-black uppercase tracking-[0.25em] leading-snug text-center">{member.role}</p>
                                    </div>
                                </div>
                                {/* Bio */}
                                <div className="p-8">
                                    <div className="text-[#d5a22d]/20 text-4xl font-serif leading-none mb-3 group-hover:text-[#d5a22d]/40 transition-colors">&ldquo;</div>
