            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl font-black text-[#36335e] tracking-tight">{university.name}</h1>
                    ...
                    <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-[#36335e]/10 overflow-hidden border border-gray-100 p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            <div className="space-y-1">
                                ...
                                <p className="text-3xl font-black text-[#36335e] tracking-tight">{university._count.programs}</p>
                            </div>
                            <div className="space-y-1">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Affiliates</label>
                                <p className="text-3xl font-black text-[#36335e] tracking-tight">{university._count.affiliates}</p>
                            </div>
                        </div>
