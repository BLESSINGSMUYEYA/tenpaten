    ...
    return (
        <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <div className="flex items-center gap-3 mb-1">
                        <div className="w-10 h-10 rounded-2xl bg-[#36335e] flex items-center justify-center">
                            <ClipboardList className="w-5 h-5 text-[#d5a22d]" />
                        </div>
                        <h1 className="text-2xl font-black text-[#36335e]">Questionnaire</h1>
                    </div>
                ...
                <div className="flex items-center gap-4 pl-[52px] sm:pl-0">
                    <div className="text-center">
                        <p className="text-2xl font-black text-[#36335e]">{activeCount}</p>
                        <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Active</p>
                    </div>
                    <div className="w-px h-8 bg-gray-100" />
                    <div className="text-center">
                        <p className="text-2xl font-black text-[#36335e]">{questions.length}</p>
            ...
            <div className="flex gap-3 p-4 rounded-2xl bg-amber-50 border border-amber-100">
                <div className="w-1.5 rounded-full bg-[#d5a22d] flex-shrink-0" />
                <div>
                    <p className="text-sm font-black text-[#36335e] mb-0.5">How this works</p>
