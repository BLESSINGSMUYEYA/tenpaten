    ...
    if (!user) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px]">
                <h2 className="text-xl font-black text-[#36335e]">Identity not found</h2>
                <Link href="/dashboard/admin/users" className="text-[#d5a22d] font-bold hover:underline mt-4">
                    Return to Registry
                </Link>
            </div>
        );
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <h1 className="text-4xl font-black text-[#36335e] tracking-tight">{user.fullName}</h1>
                        ...
                        <CardContent className="p-8 space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm font-bold text-[#36335e]">{new Date(user.createdAt).toLocaleDateString()}</span>
                                </div>
                                <div className="flex justify-between items-center">
                                    <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Applications</span>
                                    <span className="text-sm font-black text-[#d5a22d]">{user._count.applications} Records</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    {(user.managedCountry || user.managedUniversity) && (
                        <Card className="border-none shadow-2xl shadow-[#36335e]/20 rounded-[2.5rem] bg-[#36335e] text-white overflow-hidden relative group">
                            ...
                            <CardHeader className="p-8 pb-4 relative z-10">
                                <CardTitle className="text-[10px] font-black text-[#d5a22d] uppercase tracking-[0.2em]">Institutional Affiliation</CardTitle>
                            </CardHeader>
                            <CardContent className="p-8 pt-0 space-y-6 relative z-10">
                                {user.managedUniversity && (
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-xs font-black text-[#d5a22d] uppercase tracking-widest">Directing Institution</p>
                                ...
                                {user.managedCountry && (
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-xs font-black text-[#d5a22d] uppercase tracking-widest">Regional Authority</p>
...
function RoleIndicator({ role }: { role: Role }) {
    ...
    return <span className="text-sm font-black text-[#36335e]">{labels[role] || role}</span>;
}
