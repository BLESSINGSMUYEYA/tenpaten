        ...
        <div className="w-full space-y-10 pb-12 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="flex items-center gap-6">
                    <Link
                        ...
                        className="h-14 w-14 rounded-2xl bg-white shadow-xl shadow-slate-200/50 flex items-center justify-center text-slate-400 hover:text-[#36335e] hover:scale-110 transition-all duration-300 border border-slate-100"
                    >
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mt-1 font-medium flex items-center gap-2">
                            <Mail className="w-4 h-4 text-[#d5a22d]" />
                    ...
                    {affiliate.status === 'PENDING' && (
                        <div className="flex items-center gap-3 pl-3 border-l border-white/10 ml-3">
                            <form action={async () => {
                                ...
                                <Button className="h-12 px-8 bg-[#36335e] hover:bg-[#2a284a] text-white font-bold rounded-2xl shadow-lg shadow-[#36335e]/20 transition-all transform hover:scale-105 active:scale-95 leading-none">
                                    <CheckCircle className="w-4 h-4 mr-2 text-[#d5a22d]" />
                                    Approve
                                </Button>
                            </form>
                            <form action={async () => {
            ...
            <div className="grid gap-10 lg:grid-cols-3">
                <div className="lg:col-span-1 space-y-10">
                        ...
                        <CardHeader className="p-8 pb-4">
                            <CardTitle className="text-xl font-bold flex items-center gap-3">
                                <div className="p-2 rounded-xl bg-white/10 backdrop-blur-md">
                                    <TrendingUp className="w-5 h-5 text-[#d5a22d]" />
                                </div>
                                Yield Metrics
                            </CardTitle>
                        </CardHeader>
                        <CardContent className="p-8 pt-0 space-y-8">
                            <div className="grid grid-cols-2 gap-8">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-4xl font-black tracking-tighter text-[#d5a22d]">{affiliate.commissionRate}%</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-[2rem] p-6 border border-white/10 shadow-lg">
                                <form action={async (formData: FormData) => {
                                    ...
                                    <label className="text-[10px] font-black text-white/70 uppercase tracking-widest flex items-center gap-2">
                                        <BadgePercent className="w-4 h-4 text-[#d5a22d]" />
                                        Rate Adjustment
                                    </label>
                                    <div className="flex gap-2">
                                        ...
                                        />
                                        <Button size="sm" className="h-11 px-6 bg-[#d5a22d] text-[#36335e] hover:bg-[#c49220] font-black rounded-xl border-none shadow-xl">Apply</Button>
                                    </div>
                                </form>
                            </div>
                        </CardContent>
                    ...
                    <Card className="border-none shadow-xl shadow-[#36335e]/10 rounded-[2.5rem] overflow-hidden">
                        ...
                        <CardContent className="p-8 space-y-6">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-sm font-mono font-bold text-[#36335e] bg-[#36335e]/5 px-3 py-1.5 rounded-xl inline-block mt-1">
                    ...
                    {idDocument && (
                        <Card className="border-none shadow-xl shadow-[#36335e]/10 rounded-[2.5rem] overflow-hidden">
                            <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-8 pb-4">
                                <CardTitle className="text-base font-bold flex items-center gap-3">
                                    <div className="p-2 rounded-lg bg-[#36335e]/5 text-[#36335e]">
                            ...
                            <CardContent className="p-8 space-y-5">
                                <div className="flex items-center justify-between group">
                                    <div className="flex items-center gap-4">
                                        <div className="h-12 w-12 bg-slate-50 rounded-xl flex items-center justify-center text-slate-400 group-hover:bg-[#36335e]/5 group-hover:text-[#36335e] transition-colors">
                                            <FileText className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <p className="text-sm font-black text-slate-900 group-hover:text-[#36335e] transition-colors uppercase tracking-tight">{idDocument.subType}</p>
                ...
                <div className="lg:col-span-2">
                    {/* Referrals List */}
                    <Card className="border-none shadow-xl shadow-[#36335e]/10 rounded-[3rem] overflow-hidden bg-white">
                        <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-10 pb-6 flex flex-row items-center justify-between">
                            <div>
                                <CardTitle className="text-2xl font-black text-[#36335e] flex items-center gap-4 tracking-tight">
                                    <div className="p-3 rounded-2xl bg-white shadow-lg text-[#36335e]">
                                        <Users className="w-6 h-6 text-[#d5a22d]" />
                                    </div>
                                    Network Pipeline
                                </CardTitle>
                                <p className="text-slate-500 font-medium mt-1">Direct student referrals and enrollment status.</p>
                            </div>
                            <div className="h-10 px-4 bg-[#36335e]/5 rounded-xl flex items-center text-[10px] font-black text-[#36335e] uppercase tracking-[0.2em] shadow-sm">
                                ...
                                <div className="divide-y divide-slate-100">
                                    {affiliate.referrals.map((ref: any) => (
                                        <div key={ref.id} className="p-8 hover:bg-slate-50/80 transition-all flex items-center justify-between group">
                                            <div className="flex items-center gap-6">
                                                <div className="h-16 w-16 rounded-[1.5rem] bg-slate-100 shadow-inner flex items-center justify-center text-slate-400 font-black text-2xl group-hover:scale-110 group-hover:bg-[#36335e]/5 group-hover:text-[#36335e] transition-all">
                                                    {ref.prospect.fullName.charAt(0)}
                                                </div>
                                                <div>
                                                    <h4 className="text-xl font-black text-slate-900 tracking-tight group-hover:text-[#36335e] transition-colors uppercase leading-none mb-2">{ref.prospect.fullName}</h4>
                                            ...
                                            <div className="flex items-center gap-8">
                                                <div className="text-right">
                                                    ...
                                                    <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest mt-2 flex items-center justify-end gap-1.5">
                                                        <Calendar className="w-3 h-3 text-[#d5a22d]" />
                                                        {new Date(ref.createdAt).toLocaleDateString()}
                                                    </p>
                                                </div>
                                                <Button size="icon" variant="outline" className="h-12 w-12 rounded-2xl border-slate-200 text-slate-400 hover:text-[#36335e] hover:border-[#36335e]/10 hover:bg-[#36335e]/5 group-hover:scale-110 active:scale-95 transition-all" asChild>
