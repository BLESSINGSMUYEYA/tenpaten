    ...
    if (!analytics) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 text-center animate-in fade-in duration-700">
                <div className="w-24 h-24 bg-[#36335e]/5 rounded-[2.5rem] flex items-center justify-center text-[#d5a22d]">
                    <Globe className="w-12 h-12 animate-pulse" />
                </div>
                <div className="space-y-2">
                    <h1 className="text-3xl font-black text-[#36335e] tracking-tight">Profile Pending Configuration</h1>
    ...
    return (
        <div className="w-full space-y-8 pb-12 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-gray-500 mt-2 font-medium">
                        Managing Tenpaten operations in <span className="font-bold text-[#d5a22d]">{countryName}</span>
                    </p>
                </div>
                <div className="flex items-center gap-3">
                    <div className="relative group hidden sm:block">
                        ...
                        <input
                            ...
                            className="pl-12 pr-6 py-3.5 bg-slate-50/10 border border-white/10 rounded-2xl text-sm font-medium focus:ring-2 focus:ring-[#d5a22d] focus:bg-slate-50/20 transition-all w-64 shadow-sm text-white"
                        />
                    </div>
                    <Link href="/dashboard/country-director/universities/create">
                        <Button className="h-12 px-6 bg-[#36335e] hover:bg-[#2a284a] text-white font-black uppercase tracking-widest text-[10px] rounded-2xl shadow-lg shadow-[#36335e]/20 transition-all transform hover:scale-105 active:scale-95">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="border-none shadow-2xl shadow-[#36335e]/20 rounded-[2.5rem] bg-gradient-to-br from-[#36335e] to-[#2a284a] text-white overflow-hidden relative group h-full">
                    ...
                    <CardContent className="p-10 pt-2 space-y-6 relative z-10">
                        <div className="space-y-4">
                            <Link href="/dashboard/country-director/affiliates" className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/10 hover:bg-[#d5a22d]/10 transition-all cursor-pointer group/item block">
                                <div className="flex items-center justify-between mb-2">
                                    <p className="text-sm font-bold uppercase tracking-tight">Affiliate Review</p>
                                    <ChevronRight className="w-4 h-4 text-white/50 group-hover/item:translate-x-1 transition-transform group-hover/item:text-[#d5a22d]" />
                                </div>
                                <div className="flex items-center gap-2">
                                    <span className="bg-[#d5a22d] text-[#36335e] text-[10px] font-black px-2 py-0.5 rounded-md shadow-sm">
                                        {partnerCount}
                                    </span>
                                    <p className="text-[10px] uppercase tracking-widest text-white/50 font-bold">Pending Review</p>
                                </div>
                            </Link>
                            <Link href="/dashboard/country-director/universities" className="bg-white/5 backdrop-blur-md rounded-2xl p-5 border border-white/10 hover:bg-[#d5a22d]/10 transition-all cursor-pointer group/item block">
                                <div className="flex items-center justify-between mb-2">
                        ...
                        <Link href="/dashboard/country-director/applications" className="block mt-8">
                            <Button className="w-full h-14 bg-white text-[#36335e] hover:bg-[#f8fafc] font-black uppercase tracking-widest text-xs rounded-2xl shadow-xl shadow-black/20 transition-all transform hover:translate-y-[-2px]">
                                Open Regional Hub
                            </Button>
                        </Link>
                    </CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <CardHeader className="bg-slate-50/50 border-b border-slate-50 p-8">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="p-3 rounded-2xl bg-[#36335e]/10 text-[#36335e]">
                                    <TrendingUp className="w-5 h-5" />
                                </div>
                                <div>
                                    <CardTitle className="text-lg font-black text-[#36335e]">Performance Insights</CardTitle>
                ...
                <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-gray-100 relative overflow-hidden group hover:border-[#d5a22d]/20 transition-colors">
                    ...
                    <div className="space-y-4 relative z-10">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <p className="text-sm font-bold text-[#36335e] leading-tight mb-1">Partner Helpdesk</p>
