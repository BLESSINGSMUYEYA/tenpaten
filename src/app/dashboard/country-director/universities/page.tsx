        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="flex flex-wrap items-center gap-4 bg-white p-2 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <Link href="/dashboard/country-director/universities/create">
                    <Button className="bg-brand-primary hover:bg-brand-primary-hover text-white rounded-xl px-6 py-6 shadow-lg shadow-brand-primary/20 transition-all active:scale-95 flex gap-2 font-bold">
                ...
                {universities.length === 0 ? (
                    <div className="text-center py-24 px-12">
                        ...
                        <Link href="/dashboard/country-director/universities/create" className="mt-8 inline-block">
                            <Button className="bg-brand-primary hover:bg-brand-primary-hover text-white font-bold rounded-2xl px-8 h-12 shadow-lg shadow-brand-primary/20 transition-all transform hover:scale-105 active:scale-95 leading-none">
                                    ...
                                    <tr key={uni.id} className="group hover:bg-slate-50/50 transition-colors duration-300">
                                        <td className="px-8 py-6">
                                            <div className="flex items-center gap-4">
                                                <div className="h-12 w-12 rounded-xl bg-slate-100 flex items-center justify-center text-slate-400 group-hover:bg-brand-primary/5 group-hover:text-brand-primary transition-all duration-300">
                                                    <Building2 className="w-6 h-6" />
                                                </div>
                                                <div>
                                                    <p className="font-black text-slate-900 group-hover:text-brand-primary transition-colors uppercase tracking-tight leading-none mb-1">
                                                        {uni.name}
                                                    </p>
                                        ...
                                        <td className="px-8 py-6 text-right">
                                            <Link href={`/dashboard/country-director/universities/${uni.id}`}>
                                                <Button size="icon" variant="ghost" className="h-10 w-10 rounded-xl text-slate-300 hover:text-brand-primary hover:bg-brand-primary/5 transition-all">
