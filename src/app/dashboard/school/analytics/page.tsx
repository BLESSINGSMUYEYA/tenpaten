            ...
            <div className="p-10 bg-[#1d1b41] rounded-[2.5rem] text-white relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                    <div className="w-20 h-20 rounded-3xl bg-white/10 flex items-center justify-center shrink-0">
                        <TrendingUp className="w-10 h-10 text-[#d5a22d]" />
                    </div>
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-white/60 text-sm font-medium max-w-2xl leading-relaxed">
                            Based on your current yield rate of <span className="text-[#d5a22d] font-black">{overallYield}%</span> and the <span className="text-white font-black">{totalApplications}</span> pending applications, you are on track to fill <span className="text-[#d5a22d] font-black">84%</span> of your target capacity for the current intake.
                        </p>
                    </div>
