    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8 pb-12 animate-in fade-in duration-700">
            ...
            <div className="relative overflow-hidden group">
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-2">
                    <div className="space-y-4">
                        <Link 
                            href="/dashboard"
                            className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-[#d5a22d] transition-colors"
                        >
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#d5a22d] uppercase tracking-[0.3em]">
                                Partnership Program
                            </span>
                        </div>
                        <h1 className="text-3xl sm:text-4xl font-black text-[#36335e] tracking-tight">
                            Become an <span className="text-[#d5a22d]">Affiliate Partner</span>
                        </h1>
            ...
            <div className="bg-white border border-slate-100 shadow-xl shadow-slate-200/40 rounded-[2.5rem] p-6 lg:p-10 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-96 h-96 bg-[#d5a22d]/5 rounded-full blur-3xl -mr-48 -mt-48 pointer-events-none" />
