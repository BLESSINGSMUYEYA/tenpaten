...
export default async function Page() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 lg:space-y-8 pb-24 px-4 sm:px-6 lg:px-8">
            ...
            {/* 1. Hero Header */}
            <div className="relative overflow-hidden rounded-[2.5rem] bg-linear-to-br from-[#1d1b41] via-[#221f4c] to-[#1d1b41] p-8 lg:p-12 shadow-2xl border border-white/5">
                ...
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-accent/10 rounded-full blur-[120px] -mr-40 -mt-40 pointer-events-none"></div>
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8 lg:gap-12">
                        ...
                        <div className="flex justify-between items-start mb-6 lg:mb-8">
                            <div>
                                ...
                                <h2 className="text-white text-4xl lg:text-5xl font-black tracking-tight mb-3">
                                    {user?.fullName?.split(' ')[0] || 'Student'}<span className="text-brand-accent">.</span>
                                </h2>
                            ...
                            <div className="flex lg:hidden flex-col items-end gap-2">
                                ...
                                <div className="bg-white/5 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-white/10 flex items-center gap-3">
                                    <div className="w-16 h-1.5 bg-white/10 rounded-full overflow-hidden hidden sm:block">
                                        <div className="h-full bg-linear-to-r from-[#b89531] to-brand-accent rounded-full" style={{ width: `${profileData.completionPercentage}%` }} />
                                    </div>
                                    <span className="text-base font-black text-white">{profileData.completionPercentage}<span className="text-brand-accent text-xs">%</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden lg:flex">
                        <div className="bg-white/5 backdrop-blur-md p-7 rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden group hover:bg-white/10 transition-colors duration-500 min-w-[280px]">
                            <div className="absolute top-0 right-0 w-40 h-40 bg-brand-accent/20 rounded-full blur-[50px] transition-transform duration-700 group-hover:scale-150 pointer-events-none"></div>
                            <div className="relative z-10 flex flex-col gap-4">
                                <div className="flex items-end justify-between gap-8 mb-2">
                                    ...
                                    <span className="text-4xl font-black text-white leading-none">{profileData.completionPercentage}<span className="text-brand-accent text-2xl">%</span></span>
                                </div>
                                <div className="w-full h-2.5 bg-[#0a0a1a] rounded-full overflow-hidden shadow-inner">
                                    <div 
                                        className="h-full bg-linear-to-r from-[#b89531] via-brand-accent to-[#fde08b] rounded-full relative"
                                ...
                                {profileData.completionPercentage < 100 && (
                                    <Link href="/dashboard/student-settings" className="text-[10px] font-bold text-white/40 hover:text-brand-accent transition-colors mt-2 uppercase tracking-wider flex items-center justify-end gap-1">
            ...
            {actionRequiredApp && (
                <Link 
                    ...
                    className="flex items-center gap-4 bg-white rounded-2xl p-4 lg:p-5 border border-gray-100 shadow-sm border-l-4 border-l-brand-accent hover:shadow-md transition-all active:scale-[0.98]"
                >
                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-brand-accent/10 flex items-center justify-center flex-shrink-0">
                        <AlertCircle className="w-5 h-5 lg:w-6 lg:h-6 text-brand-accent" />
                    </div>
            ...
            <div>
                ...
                <div className="grid grid-cols-4 gap-3 lg:gap-6">
                    <Link href="/dashboard/colleges" className="flex flex-col items-center gap-2 lg:gap-4 p-3 lg:p-6 rounded-2xl lg:rounded-[2rem] bg-white border border-gray-100 shadow-sm hover:border-brand-accent/30 hover:shadow-lg transition-all active:scale-95 group">
                        <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-[#1d1b41]/5 flex items-center justify-center group-hover:bg-brand-accent/10 transition-colors">
                            <Building2 className="w-5 h-5 lg:w-7 lg:h-7 text-[#1d1b41] group-hover:text-brand-accent" />
                        </div>
                        <span className="text-[9px] lg:text-[11px] font-black text-[#1d1b41] uppercase tracking-widest text-center">Browse</span>
                    </Link>
                    <Link href="/dashboard/apply" className="flex flex-col items-center gap-2 lg:gap-4 p-3 lg:p-6 rounded-2xl lg:rounded-[2rem] bg-white border border-gray-100 shadow-sm hover:border-brand-accent/30 hover:shadow-lg transition-all active:scale-95 group">
                        <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-[#1d1b41]/5 flex items-center justify-center group-hover:bg-brand-accent/10 transition-colors">
                            <Sparkles className="w-5 h-5 lg:w-7 lg:h-7 text-[#1d1b41] group-hover:text-brand-accent" />
                        </div>
                        <span className="text-[9px] lg:text-[11px] font-black text-[#1d1b41] uppercase tracking-widest text-center">Apply</span>
                    </Link>
                    <Link href="/dashboard/applications" className="flex flex-col items-center gap-2 lg:gap-4 p-3 lg:p-6 rounded-2xl lg:rounded-[2rem] bg-white border border-gray-100 shadow-sm hover:border-brand-accent/30 hover:shadow-lg transition-all active:scale-95 group">
                        <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-[#1d1b41]/5 flex items-center justify-center group-hover:bg-brand-accent/10 transition-colors">
                            <FileText className="w-5 h-5 lg:w-7 lg:h-7 text-[#1d1b41] group-hover:text-brand-accent" />
                        </div>
                        <span className="text-[9px] lg:text-[11px] font-black text-[#1d1b41] uppercase tracking-widest text-center">Track</span>
                    </Link>
                    <Link href="/dashboard/messages" className="flex flex-col items-center gap-2 lg:gap-4 p-3 lg:p-6 rounded-2xl lg:rounded-[2rem] bg-white border border-gray-100 shadow-sm hover:border-brand-accent/30 hover:shadow-lg transition-all active:scale-95 group">
                        <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-full bg-[#1d1b41]/5 flex items-center justify-center group-hover:bg-brand-accent/10 transition-colors">
                            <MessageCircle className="w-5 h-5 lg:w-7 lg:h-7 text-[#1d1b41] group-hover:text-brand-accent" />
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">
                    ...
                    <div>
                        ...
                        {mostRecentApp ? (
                            ...
                            <div className="bg-white rounded-3xl border border-gray-100 p-8 lg:p-12 text-center shadow-sm">
                                ...
                                <Link href="/dashboard/colleges" className="inline-flex items-center justify-center gap-2 w-full lg:w-auto px-8 py-3.5 rounded-xl lg:rounded-2xl bg-[#1d1b41] text-white text-[10px] lg:text-xs font-black uppercase tracking-widest shadow-lg hover:bg-brand-primary-hover transition-all">
                                    Browse Universities
                                </Link>
                            </div>
                        )}
                    ...
                    {sortedApps.length > 1 && (
                        <div>
                            <div className="flex items-center justify-between mb-4 px-1">
                                ...
                                <Link href="/dashboard/applications" className="text-[10px] lg:text-xs font-black text-brand-accent uppercase tracking-[0.2em] hover:text-[#b89531] transition-colors flex items-center gap-1">
                            ...
                            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
                                {sortedApps.slice(1, 4).map((app, index) => (
                                    ...
                                    >
                                        <div className={`w-2 h-2 lg:w-3 lg:h-3 rounded-full ${app.status === 'REJECTED' ? 'bg-red-500' : app.status === 'ENROLLED' ? 'bg-brand-accent' : ['OFFER_ISSUED', 'OFFER_ACCEPTED'].includes(app.status) ? 'bg-emerald-500' : 'bg-[#1d1b41]'}`} />
                                        <div className="flex-1 min-w-0">
                ...
                <div className="lg:col-span-4 space-y-6 lg:space-y-8">
                    {/* 5. Promote Banner */}
                    <div className="relative overflow-hidden rounded-[2rem] bg-linear-to-br from-brand-accent to-[#b89531] p-6 lg:p-8 shadow-xl shadow-brand-accent/20 flex flex-col items-start gap-4 group">
                        ...
                        <Link 
                            ...
                            className="relative z-10 inline-flex bg-[#1d1b41] text-white px-6 py-3.5 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-widest hover:bg-brand-primary-hover shadow-lg active:scale-95 transition-all w-full justify-center"
                        >
                            Explore Program
                        </Link>
                    </div>
