    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-black text-brand-primary tracking-tight">Settings</h1>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className="w-full md:w-72 bg-gray-50 border-b md:border-b-0 md:border-r border-gray-100 p-6 space-y-3">
                    ...
                    >
                        <div className={`p-2 rounded-lg ${activeTab === 'profile' ? 'bg-brand-primary/10 text-brand-primary' : 'bg-gray-100 text-gray-400'}`}>
                    ...
                    >
                        <div className={`p-2 rounded-lg ${activeTab === 'security' ? 'bg-brand-primary/10 text-brand-primary' : 'bg-gray-100 text-gray-400'}`}>
                ...
                <div className="flex-1 p-8 md:p-12 bg-white">
                    {activeTab === 'profile' && (
                        <div className="max-w-2xl space-y-8 animate-in slide-in-from-right-4 duration-500 fade-in">
                            <div>
                                <h2 className="text-xl font-black text-brand-primary tracking-tight mb-2">Personal Information</h2>
                    ...
                    {activeTab === 'security' && (
                        <div className="max-w-2xl space-y-8 animate-in slide-in-from-right-4 duration-500 fade-in">
                            <div>
                                <h2 className="text-xl font-black text-brand-primary tracking-tight mb-2">Security Settings</h2>
