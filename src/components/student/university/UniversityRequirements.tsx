        ...
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">Admission <span className="text-brand-accent">Requirements</span></h2>
                </div>
                    ...
                    <div key={i} className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-500" style={{ animationDelay: `${i * 150}ms` }}>
                        ...
                        <div className="space-y-3 pl-2">
                            {section.items.map((item: string, j: number) => (
                                <div key={j} className="flex items-start gap-4 group/item py-2 border-l border-white/5 pl-4 transition-all hover:border-brand-accent/50">
                                    <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-brand-accent/30 group-hover/item:bg-brand-accent transition-colors shrink-0" />
            ...
            <div className="bg-white/5 backdrop-blur-md p-8 rounded-[2.5rem] border border-white/10 flex flex-col sm:flex-row items-center gap-8 text-white relative overflow-hidden">
                ...
                <div className="w-16 h-16 bg-brand-accent/20 rounded-2xl flex items-center justify-center flex-shrink-0 backdrop-blur-md border border-brand-accent/20">
                    <AlertCircle className="w-8 h-8 text-brand-accent" />
                </div>
                <div className="space-y-2 relative z-10 text-center sm:text-left">
                    <h4 className="font-black text-sm tracking-[0.2em] uppercase text-brand-accent">Important Note</h4>
