                    ...
                    <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between gap-12">
                        <div className="space-y-8 max-w-3xl text-center lg:text-left">
                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                                ...
                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#d5a22d]/20 text-[#d5a22d] text-[9px] font-black uppercase tracking-[0.2em] border border-[#d5a22d]/20">
                            ...
                            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-5 pt-4">
                                <Link
                                    ...
                                    className="inline-flex items-center justify-center gap-3 h-14 px-10 rounded-2xl bg-white text-[#1a1b41] font-black uppercase tracking-widest text-[11px] shadow-2xl hover:bg-[#d5a22d] hover:text-[#1a1b41] transition-all hover:-translate-y-1 active:scale-95 group"
                                >
                                    Apply Now
                        ...
                        <div className="hidden lg:flex flex-col gap-4">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-4 bg-white/5 backdrop-blur-sm border border-white/10 px-6 py-4 rounded-3xl cursor-default group/stat">
                                    <div className="w-12 h-12 rounded-2xl bg-[#d5a22d]/20 flex items-center justify-center text-[#d5a22d] group-hover/stat:scale-110 transition-transform">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-2xl bg-[#1a1b41] flex items-center justify-center shadow-lg shadow-[#1a1b41]/20">
                                    <BookOpen className="w-6 h-6 text-[#d5a22d]" />
                                </div>
                                <div>
                                    <h2 className="text-2xl font-black text-[#1a1b41] tracking-tighter">
                                        About <span className="text-[#d5a22d]">Program</span>
                                    </h2>
                            ...
                            {program.majors?.length > 0 && (
                                <div className="space-y-4 pt-6 border-t border-gray-50">
                                    <div className="flex items-center gap-3">
                                        <Sparkles className="w-5 h-5 text-[#d5a22d]" />
                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">Admission <span className="text-[#d5a22d]">Criteria</span></h2>
                                </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center">
                                        <ShieldCheck className="w-5 h-5 text-[#d5a22d]" />
                                    </div>
                            ...
                            <div className="bg-[#d5a22d]/10 border border-[#d5a22d]/20 p-8 rounded-[2rem] flex items-start gap-5">
                                <AlertCircle className="w-6 h-6 text-[#d5a22d] shrink-0" />
                                <div className="space-y-1">
                                    <p className="text-[10px] font-black text-[#d5a22d] uppercase tracking-widest">Counselor's Tip</p>
                ...
                <div className="lg:col-span-4 sticky top-24 space-y-6">
                    ...
                    <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl relative overflow-hidden group">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#d5a22d]/10 text-[#d5a22d] text-[10px] font-black uppercase tracking-[0.2em] mb-6">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center gap-5 group/item transition-all">
                                <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#1a1b41]/5 transition-all shadow-sm">
                                    <Wallet className="w-6 h-6 text-gray-400 group-hover/item:text-[#d5a22d] transition-colors" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-center gap-5 group/item transition-all">
                                <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#1a1b41]/5 transition-all shadow-sm">
                                    <Clock className="w-6 h-6 text-gray-400 group-hover/item:text-[#d5a22d] transition-colors" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Program Duration</p>
                                    <p className="text-sm font-black text-[#36335e] tracking-tight">{program.duration || 'Flexible'}</p>
                                </div>
                            </div>

                            <div className="flex items-center gap-5 group/item transition-all">
                                <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center flex-shrink-0 group-hover/item:bg-[#1a1b41]/5 transition-all shadow-sm">
                                    <Calendar className="w-6 h-6 text-gray-400 group-hover/item:text-[#d5a22d] transition-colors" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-1">Next Intake</p>
                                    <p className="text-sm font-black text-[#36335e] tracking-tight">{program.intake || 'Ongoing'}</p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="bg-[#1a1b41] rounded-[4rem] p-10 sm:p-16 text-center space-y-10 relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-6 max-w-3xl mx-auto">
                        <div className="flex flex-col items-center gap-4 mb-4">
                            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#d5a22d]/20 text-[#d5a22d] text-[10px] font-black uppercase tracking-[0.3em] border border-[#d5a22d]/30 animate-pulse">
                                Admissions Priority Open
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-4xl font-black text-white tracking-tighter leading-none">
                            Your future at <span className="text-[#d5a22d]">{program.university.name}</span> starts here.
                        </h2>
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Link 
                            href={`/dashboard/apply?programId=${program.id}`}
                            className="h-14 px-10 bg-[#d5a22d] text-[#1a1b41] flex items-center justify-center font-black rounded-2xl text-[10px] uppercase tracking-[0.2em] hover:bg-white transition-all hover:scale-105 active:scale-95 shadow-2xl"
                        >
                            Apply Now
                        </Link>
                        <button 
