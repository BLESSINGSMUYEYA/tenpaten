...
export default function WelcomeBanner() {
    ...
    return (
        <div className="mb-8 animate-in fade-in slide-in-from-top-4 duration-700">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#1d1b41] via-[#2a285a] to-[#1d1b41] p-px shadow-xl shadow-[#1d1b41]/20">
                <div className="relative bg-white/5 backdrop-blur-xl rounded-[15px] p-6 sm:p-8">
                    ...
                    <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-48 h-48 bg-[#d5a22d]/10 rounded-full blur-3xl pointer-events-none" />
