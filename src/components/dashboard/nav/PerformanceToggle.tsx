            ...
            <button
                ...
                className={`w-full flex items-center justify-between p-3 rounded-xl border transition-all duration-300 group ${
                    isLiteMode 
                        ...
                        : 'bg-[#1d1b41]/5 border-[#1d1b41]/10 text-[#1d1b41]/60 hover:bg-[#1d1b41]/10 hover:text-[#1d1b41]'
                }`}
            >
                <div className="flex items-center gap-3">
                    <div className={`p-1.5 rounded-lg transition-colors ${
                        isLiteMode ? 'bg-amber-500 text-white' : 'bg-[#1d1b41]/10 text-[#1d1b41]/40'
                    }`}>
                ...
                <div className={`w-8 h-4 rounded-full relative transition-colors duration-300 ${
                    isLiteMode ? 'bg-amber-500' : 'bg-[#1d1b41]/20'
                }`}>
                    <div className={`absolute top-0.5 w-3 h-3 bg-white shadow-sm rounded-full transition-all duration-300 ${
                        isLiteMode ? 'translate-x-4' : 'translate-x-0.5'
                    }`} />
                </div>
            </button>
        </div>
