    ...
    return (
        <div className="flex flex-col h-full overflow-y-auto custom-scrollbar">
            <div className="pt-6 pb-2 px-4">
                <span className="text-[10px] font-black text-brand-accent/70 uppercase tracking-[0.2em]">Management Console</span>
            </div>
            ...
            <div className="p-4">
                <div className="bg-white/5 rounded-2xl p-4 border border-white/10">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <p className="text-[10px] font-black text-brand-accent uppercase tracking-widest">Support Active</p>
                    </div>
