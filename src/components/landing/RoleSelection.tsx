                ...
                <div className="grid lg:grid-cols-5 gap-6">
                    ...
                    >
                        ...
                        <div className="absolute inset-0 z-0">
                            ...
                            <div className="absolute inset-0 bg-linear-to-t from-[#1a1b41] via-[#1a1b41]/80 to-transparent" />
                            {/* Gold dot grid */}
                            <div
                        ...
                        <div className="relative z-10 flex flex-col flex-1 p-8 lg:p-12">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-brand-accent/30 bg-brand-accent/10 w-fit mb-auto">
                                <GraduationCap className="w-3 h-3 text-brand-accent" />
                                <span className="text-brand-accent text-[10px] font-black tracking-[0.3em] uppercase">For Students</span>
                            </div>
                            ...
                            <div className="my-8 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 p-4 space-y-3">
                                ...
                                <div className="flex items-center gap-2 pt-1">
                                    <div className="h-1.5 flex-1 rounded-full bg-white/10">
                                        <div className="h-full w-[86%] rounded-full bg-brand-accent" />
                                    </div>
                                    <span className="text-brand-accent text-[9px] font-black">86% Profile</span>
                                </div>
                            </div>
                            ...
                            <div>
                                <h3 className="text-3xl lg:text-4xl font-black text-white uppercase tracking-tighter leading-[0.9] mb-4">
                                    ...
                                    <span className="text-brand-accent">We Find It a Home.</span>
                                </h3>
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-brand-accent text-[#1a1b41] font-black uppercase tracking-[0.2em] text-xs hover:bg-white transition-all shadow-lg shadow-brand-accent/20 active:scale-95 group/btn"
                                >
                                    Start Your Journey
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-6">
                        ...
                        <motion.div
                            ...
                            className="group relative flex-1 rounded-[2.5rem] overflow-hidden bg-brand-accent p-8 lg:p-10 flex flex-col shadow-[0_32px_64px_-16px_rgba(213,162,45,0.3)] border border-brand-accent/30 min-h-[250px]"
                        >
                            {/* Background texture */}
                            <div
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {[
                                            ...
                                            <div key={i} className="bg-white/5 rounded-xl p-3 border border-white/5">
                                                <item.icon className="w-4 h-4 text-brand-accent mb-1.5" />
                                                <p className="text-white text-[10px] font-black">{item.label}</p>
                                                <span className="text-[8px] font-black text-brand-accent uppercase">{item.chip}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <motion.div
                            ...
                            className="group rounded-[2.5rem] border border-gray-100 bg-white p-8 lg:p-10 flex flex-col shadow-[0_24px_48px_-12px_rgba(0,0,0,0.05)] hover:shadow-[0_48px_80px_-24px_rgba(0,0,0,0.08)] hover:border-brand-accent/20 transition-all duration-500"
                        >
                            ...
                            <Link
                                href="/contact"
                                className="inline-flex items-center gap-2 text-brand-accent font-black uppercase tracking-[0.25em] text-[10px] hover:text-[#1a1b41] transition-colors group/btn"
                            >
                                Get in Touch
                                <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                            </Link>
