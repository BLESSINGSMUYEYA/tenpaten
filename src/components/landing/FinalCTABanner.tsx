    ...
    return (
        <section className="bg-[#0f1030] py-28 lg:py-40 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-[#0f1030] via-transparent to-[#0f1030]" />
            ...
            <div className="absolute inset-0 pointer-events-none z-10">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-brand-accent opacity-[0.08] blur-[140px]" />
                {/* Dot grid */}
                <div
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20">
                ...
                <motion.div
                    ...
                    className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full border border-brand-accent/25 bg-brand-accent/10 mb-12 backdrop-blur-md"
                >
                ...
                >
                    Your Future<br />
                    <span className="text-brand-accent">Starts Today.</span>
                </motion.h2>
                ...
                >
                    ...
                    <span className="text-brand-accent font-black">It&apos;s completely free.</span>
                </motion.p>
                ...
                >
                    <Link
                        ...
                        className="group relative inline-flex items-center justify-center gap-3 px-14 py-6 rounded-2xl bg-brand-accent text-[#1a1b41] font-black uppercase tracking-[0.2em] text-[11px] hover:bg-white transition-all shadow-[0_20px_50px_-15px_rgba(213,162,45,0.4)] active:scale-95 overflow-hidden"
                    >
